...
from src.tools import search_music_by_mood

async def get_music_team()->RoundRobinGroupChat:
    ...
    approver = AssistantAgent(
        ...
        When you receive a list of songs, format them nicely and say APPROVED.
        
        Format the songs like this:
        🎵 Here are some great songs for you:
        
        1. Song Title - Artist (Genre | Duration)
        2. Song Title - Artist (Genre | Duration)
        ...
        """
    )

    # Termination condition: either 5 messages or APPROVED
    termination_condition = MaxMessageTermination(5) | TextMentionTermination("APPROVED")
...
if __name__ == "__main__":
    ...
    team = asyncio.run(get_music_team())
